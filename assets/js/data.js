...
TS.universalProducts = [
  ...
  { id: "cera-cristalizadora", name: "Cera cristalizadora automotiva", brand: "Vonixx", desc: "Proteção e brilho para a pintura, aplicação simples.", icon: "bodykit", price: "R$ 55", network: "shopee", category: "cleaning" },
  ...
  { id: "central-multimidia", name: "Central multimídia CarPlay/Android Auto", brand: "Pioneer", desc: "Tela touch universal com espelhamento sem fio.", icon: "speaker", price: "R$ 890", network: "shopee", category: "audio" },
  { id: "kit-led-interno", name: "Kit LED interno e placa", brand: "Philips", desc: "Substitui as lâmpadas incandescentes de fábrica por LED branco.", icon: "headlight", price: "R$ 89", network: "shopee", category: "lighting" },
];
...
TS.topLists = [
  ...
  },
  {
    ...
    items: [
      { id: "s1-filtro", name: "Filtro de ar esportivo", brand: "K&N", desc: "Primeiro upgrade, barato e reversível.", icon: "filter", price: "R$ 180", network: "mercadolivre", category: "performance" },
      ...
      { id: "s1-molas", name: "Molas esportivas", brand: "Eibach", desc: "Reduz altura e melhora handling sem trocar amortecedor.", icon: "coilover", price: "R$ 650", network: "mercadolivre", category: "performance" },
      ...
      { id: "s1-manometro", name: "Manômetro de pressão (boost)", brand: "Autometer", desc: "Acompanha a pressão do turbo em tempo real.", icon: "gauge", price: "R$ 210", network: "shopee", category: "performance" },
      { id: "s1-intercooler", name: "Intercooler frontal (FMIC)", brand: "Garrett", desc: "Reduz temperatura do ar de admissão em uso intenso.", icon: "turbo", price: "R$ 1.800", network: "mercadolivre", category: "performance" },
      { id: "s1-farol-led", name: "Kit de faróis LED", brand: "Osram", desc: "Upgrade estético e de visibilidade noturna.", icon: "headlight", price: "R$ 380", network: "shopee", category: "lighting" },
